    ...
    <div class="container hero__content">
      ...
      <div class="hero__platforms">
        <div class="hero__platforms-icons">
           <a :href="settings?.music_youtube ?? '#'" target="_blank" rel="noopener noreferrer" class="hero__platforms-icon" aria-label="YouTube Music">
          ...
          <a :href="settings?.music_yandex ?? '#'" target="_blank" rel="noopener noreferrer" class="hero__platforms-icon" aria-label="Yandex Music">
          ...
          <a :href="settings?.music_apple ?? '#'" target="_blank" rel="noopener noreferrer" class="hero__platforms-icon" aria-label="Apple Music">
            <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24">
          ...
          <a :href="settings?.music_spotify ?? '#'" target="_blank" rel="noopener noreferrer" class="hero__platforms-icon" aria-label="Spotify">
            <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24">
          ...
          <a :href="settings?.music_zvuk ?? '#'" target="_blank" rel="noopener noreferrer" class="hero__platforms-icon" aria-label="Zvuk">
