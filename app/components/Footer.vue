      ...
      <div class="footer__row">
        <div class="footer__col footer__col--left">
          ...
          <div class="footer__info">
            <span class="footer__label">Booking</span>
            <a href="mailto:booking@sipe.music" class="footer__link">booking@sipe.music</a>
          </div>
        </div>
        <div class="footer__col footer__col--center">
          <div class="footer__socials">
            ...
            <div class="footer__icons">
              <a href="#" class="footer__icon" aria-label="VK">
              ...
              <a href="#" class="footer__icon" aria-label="Telegram">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
                  <path d="M0 0h24v24H0z" fill="none" />
              ...
              <a href="#" class="footer__icon" aria-label="YouTube">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
                  <path d="M0 0h24v24H0z" fill="none" />
        ...
        <div class="footer__col footer__col--right">
          <div class="footer__info">
            <span class="footer__label">Пресса / сотрудничество</span>
            <a href="mailto:press@sipe.music" class="footer__link">press@sipe.music</a>
          </div>
        </div>
      </div>
      <div class="footer__row">
